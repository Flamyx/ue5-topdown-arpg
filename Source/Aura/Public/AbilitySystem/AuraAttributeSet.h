...
// typedef is is specific to FGameplayAttribute() signature, but template is generic to ANY signature chosen
...
public:
	...
	//TBaseStaticDelegateInstance<FGameplayAttribute(), FDefaultDelegateUserPolicy>::FFuncPtr EQUAL TO FGameplayAttribute(*)()
	...
	*/
	...
	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_ArcaneResistance, Category = "Secondary Attributes | Resistances")
